...
import { CreateStaffBrandDto } from "src/dto/CreateStaffBrandDto";
import { UpdateStaffBrandDto } from "src/dto/UpdateStaffBrandDto";
...
export class StaffBrandsController {
  ...
  async findAll(@Request() req) {
    return this.staffBrandsService.findAll();
  }
